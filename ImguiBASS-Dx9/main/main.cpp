...
int main(int, char**) 
{
    ...
    HWND hwnd = ::CreateWindow(wc.lpszClassName, _T("DX9 Example"), WS_OVERLAPPEDWINDOW, 0, 0, 50, 50, NULL, NULL, wc.hInstance, NULL);
	::RegisterClassEx(&wc);
	...
	// Init Direct3d
	if (DX_9::CreateDeviceD3D(hwnd))
	{
        printf("Successfully Created!!!");
	}
    else {
        DX_9::CleanupDeviceD3D();
